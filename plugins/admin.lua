local function set_bot_photo(msg, success, result)
  ...
  if success then
    ...
    send_large_msg(receiver, 'مشکل!دوباره امتحان کنید!', ok_cb, false)
  end
end
...
local function run(msg,matches)
    ...
    if matches[1] == "setbotphoto" then
    	...
    	return 'عکس جدید پروفایل آدیکس1 را ارسال کنید'
    end
    ...
    if matches[1] == "pm" then
    	local text = "پیام از "..(msg.from.username or msg.from.last_name).."\n\nپیام : "..matches[3]
    ...
    if matches[1] == "contactlist" then
      ...
      return "لیست مخاطبین من در خصوصی آرش ارسال شد"
    end
   ...
   return "کاربر با شماره تلفن +"..matches[2].." به لیست مخاطبین اضافه شد"
end
 ...
 if matches[1] == "mycontact" and is_sudo(msg) then
    ...
    if matches[1] == "dialoglist" then
      ...
      return "به خصوصی ارسال شد قربان!"
    end
	...
	if matches[1] == 'reload' then
		...
		return "شروع دوباره و دریافت دوباره اطلاعات!"
	end
	--[[*For Debug*
